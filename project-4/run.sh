...
make clean
echo "Array Size (#), Non SIMD Mult (MegaMults/sec), SIMD Mult (MegaMults/sec), Mult Speedup, Non SIMD Mult Sum (MegaMultSums/sec), SIMD Mult Sum (MegaMultSums/sec), Mult Sum Speedup" >> "$output_file"
